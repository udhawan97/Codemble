...
<p align="center">
  <a href="https://github.com/udhawan97/Codemble/releases/tag/v0.15.0"><img src="https://img.shields.io/badge/stable-v0.15.0-2b4d96?style=flat-square" alt="Stable release v0.15.0"></a>
...
<p align="center">
  <img src="https://github.com/udhawan97/Codemble/raw/main/docs-site/public/shots/galaxy.png" alt="Codemble v0.15.0 showing 171 represented systems across seven languages, with ranked labels, selective import routes, 30 systems charted, six unreadable test fixtures called out, and Home still unlit." width="1000">
</p>

<p align="center"><sub>
  Codemble v0.15.0 · every module is represented before the first lesson ·
...
> [!IMPORTANT]
> **The screen above and the packaged app are both v0.15.0.** The PyPI release
...
| <img src="https://github.com/udhawan97/Codemble/raw/main/docs-site/public/brand/icons/run.svg" width="22" height="22" alt=""> | **Open this release** — pick a project in the browser | `uvx --from codemble==0.15.0 codemble` |

No Homebrew? Use uv's [official installer](https://docs.astral.sh/uv/getting-started/installation/),
or install permanently with `pipx install codemble==0.15.0` and run `codemble`.
Pass a folder to skip the project picker:
`uvx --from codemble==0.15.0 codemble ./my-project`.
Use the shorter `uvx codemble` when you intentionally want whatever release is
newest on PyPI.

<p align="center">
  <a href="https://pypi.org/project/codemble/0.15.0/#files">
...
<p align="center">
  <a href="https://files.pythonhosted.org/packages/9a/e8/9e7479b75f9db58a82ae4502805073f4f0faf070b625a02a9019a8545901/codemble-0.15.0-py3-none-any.whl"><img src="https://github.com/udhawan97/Codemble/raw/main/docs-site/public/brand/icons/download.svg" alt="" width="18"> Wheel</a> ·
  <a href="https://files.pythonhosted.org/packages/b4/0b/308128981fa46aa39bf48f18cfc90c9d72700d58d6d550bc6e91e98a9317/codemble-0.15.0.tar.gz"><img src="https://github.com/udhawan97/Codemble/raw/main/docs-site/public/brand/icons/package.svg" alt="" width="18"> Source archive</a> ·
  <a href="https://pypi.org/project/codemble/0.15.0/#files"><img src="https://github.com/udhawan97/Codemble/raw/main/docs-site/public/brand/icons/shield.svg" alt="" width="18"> SHA256 digests</a> ·
  <a href="https://github.com/udhawan97/Codemble/releases/tag/v0.15.0"><img src="https://github.com/udhawan97/Codemble/raw/main/docs-site/public/brand/icons/release.svg" alt="" width="18"> Release notes</a>
</p>

### Build the same v0.15.0 app from source
...
| Horizon | Work |
| --- | --- |
| **Now** | Collect unaided learner evidence and correctness reports on v0.15.0 |
