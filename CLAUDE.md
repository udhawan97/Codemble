...
the tag-only upload/download artifact handoff remains a next-release
verification point. The v0.16.0 release context follows: three evidence-led
audit loops against the served v0.15.0 build found eight gaps; UD then reported
six more from the running app, and **the ones UD found were the more serious**,
which is the finding worth keeping. Released as **v0.16.0**.
