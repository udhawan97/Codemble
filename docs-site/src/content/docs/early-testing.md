...
it better. v0.22.0 reads Python, JavaScript, TypeScript, Go, Java, Rust, C#, Ruby, PHP, or
any mix.
...
Prefer a permanent install? `pipx install codemble==0.22.0`, then run `codemble` — no
uv needed.

Codemble opens your browser to an in-app picker — pick your project folder
there, or pass one directly:
`uvx --from codemble==0.22.0 codemble ./path-to-your-project`.
