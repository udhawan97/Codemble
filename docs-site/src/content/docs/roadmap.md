---
title: Roadmap
description: NOW, NEXT, and LATER — built in public.
---

The authoritative roadmap lives in the repo's
...
Packaged v0.15.0 and current source map Python, JavaScript, TypeScript, Go,
