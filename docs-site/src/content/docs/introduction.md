...
graph — no guessing — and renders it as a **3D galaxy**: modules are star
systems, functions are planets, your entrypoint is Home. Every node starts dim.

You explore, read explanations grounded in your actual source, learn the
...
own it. You bring your own Claude or OpenAI API key; everything else runs
