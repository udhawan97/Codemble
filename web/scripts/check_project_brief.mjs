...
const overview = {
  ...
  importCycles: [["garden.shared", "web/src/main.ts", "worker.queue"]],
  understood: 1,
};
...
- Strongly connected group: garden.shared, web/src/main.ts, worker.queue. Each file can reach every other through proven imports.
